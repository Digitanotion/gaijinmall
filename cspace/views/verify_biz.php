      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Verify View</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12">
          <div class="card">
            ...
            <?php
                ...
                $files = $accManager->getUserKyc($details['mallUsrID']);
                if($files['status'] == 1){
          
                  //fetch the file
                  $frontSrc = "../../media_store/idFiles/uploads/".$files['message'][0]['mallIDDocFile'] ;
                  $backSrc = "../../media_store/idFiles/uploads/".$files['message'][0]['mallIDDocType'] ;
                  ?>
                  <div class='row justify-content-center'>
                      <div class='col-12 col-sm-6 col-md-3'>
                        ...
                        <div class='text-center mt-2'>
                          <a href="<?php  echo $frontSrc ?>" class='btn btn-info px-4'>View</a>
                        </div>
                        <!-- /.info-box -->
                      </div>
                      <!-- /.col -->
                      ...
                      <div class='col-12 col-sm-6 col-md-3'>
                        ...
                        <div class='text-center mt-2'>
                          <a href="<?php  echo $backSrc ?>" class='btn btn-info px-4'>View</a>
                        </div>
                        <!-- /.info-box -->
                      </div>

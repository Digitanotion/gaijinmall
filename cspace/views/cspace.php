                        ...
                        if($recentUsers['status'] == 1){
                           foreach($recentUsers['message'] as $row){
                                ...
                                if(empty($image)){
                                  ...
                                  if($gender == "male"){
                                    $src = "../../handlers/uploads/optimized/ma.jpg";
                                  }else{
                                    $src = "../../handlers/uploads/optimized/fm.jpg";
                                  }
                                }else{
                                  $src = "../../handlers/uploads/optimized/".$image;
                                }
                                
                              echo ' <li>
                                      <img class="img-fluid w-25" src='.$src.' alt="User Image">

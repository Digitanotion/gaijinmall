...
USE services\DspS\DisputeManager;
          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="adList" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php 
                  $allDsps = $dspManager->getAllUsrDispute();

                    if ($allDsps['status']==1){
                        foreach ($allDsps['message'] as $all) {
                          $defaultColID = $all['defaultcolid'];
                          $mallUsrID = $all['mallUsrID'];
                          $userName = $all['mallUsrFirstName']." ".$all['mallUsrLastName'];
                          $reportReason = $all['mallAdReportReason'];
                          $reportMsg = $all['mallAdReportMsg'];
                          ...
                          echo '<tr>
                                ...
                                <td title="dispute action"> <a onclick="" class="text-danger mx-1" title="Reject Dispute"><i class="fas fa-thumbs-down"></i></a>  <a onclick="" class="text-success
                                 mx-1" title="Mark As Resolved"><i class="fas fa-thumbs-up"></i></a></td>

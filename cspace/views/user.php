  ...
  <!-- End Add New Category -->
        ...
        <?php 
              ...
              if($usr['status'] == 1){
                  ...
                  $myID = $details['mallUsrID'];
                  $image = $details['mallUsrPhoto'];
                  $gender = $details['mallUsrSex'];

                  if(empty($image)){

                    if($gender == "male"){
                      $src = "../../media_store/profileFiles/optimized/ma.jpg";
                    }else{
                      $src = "../../media_store/profileFiles/optimized/fm.jpg";
                    }
                  }else{
                    $src = "../../media_store/profileFiles/optimized/".$image;
                  }
              }
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <img class="img-fluid" src="<?php echo $src; ?>" style="border-radius:50%; height:80px; width:80px; float:right; border:2px solid black"> 
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
          ...
          <div class="card">
            ...
            <?php 
              ...
              if($usr['status'] == 1){
                  ...
                  $details = $usr['message'];
                  $acctStat = $details['mallUsrAccountStatus'];
                  $balance = $details['mallUsrBalance'];
                  $userID = $details['mallUsrID'];

                  $adStat = $adManager->getUserAdStats($details['mallUsrID']);
                  if($adStat['status'] == 1){
                    $regularAds = $adStat['message']['regular'];
                    $promotedAds = $adStat['message']['promoted'];
                  }
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-sm-6 col-md-3">
                  <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                      <span class="info-box-text">Number of Ads</span>
                      <span class="info-box-number"><?php echo $regularAds; ?></span>
                    </div>
                    <!-- /.info-box-content -->
                  </div>
                  <!-- /.info-box -->
                ...
                <div class="col-12 col-sm-6 col-md-3">
                  <a href="#" class="text-dark">
                    ...
                    <span class="info-box-icon bg-danger elevation-1"><i class="fas fa-ad"></i></span>
                      ...
                      <div class="info-box-content">
                        <span class="info-box-text">Premium Ads</span>
                        <span class="info-box-number"><?php echo $promotedAds; ?></span>
                    </div>
                    <!-- /.info-box-content -->
                  </div>
                  </a>
              ...
              <div class="card-body">
                <h5>Ads Record for <?php echo $userName; ?></h5>
              <table id="adList" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php 
                     ...
                     $inc = 0;
                     $allAds = $adManager->getUserAds($userID);
                     if ($allAds['status']==1){
                        foreach ($allAds['message'] as $ad) {
                          ...
                          if($ad['mallAdNegotiable']){
                            ...
                            echo '<tr>
                            <td>'.$inc.'</td>
                            <td><a href="https://gaijinmall.com/product.php?adID='.$adID.'">'.$adTitle.'</a></td>
                            <td>'.$adLoc.'</td>
                            <td>'.$adCategory.'</td>
                            <td>'.$adDesc.'</td>
                            <td>'.$negotiable.'</td>
...
<div id="notify" class="container-fluid" style="display:none; position:fixed; bottom:0; z-index:999999; background-color:white; padding-top:15px; height:max-content; padding-bottom:0;">
    <span style="float:right; color:red;" onclick="hide('notify')">close</span>
    <div class="row justify-content-center" style="padding:20px;">
        <p class="text-center" style="color:red; display:block; width:100%;">Are you sure to deactivate this user?</p><br>
        <div class="row justify-content-between">
            <button type="button" class="btn btn-success mb-2" style="width:100%;">proceed</button>
...
<div id="notifyMsg" class="container-fluid" style="display:none; position:fixed; bottom:0; z-index:999999; background-color:white; padding-top:15px; height:max-content; padding-bottom:0;">
    <span style="float:right; color:red;" onclick="hide('notifyMsg')">close</span>
    <div class="row justify-content-center" style="padding:20px;">
       <form method="POST">
              <input type="text" style="padding:20px; width:100%;" placeholder="Type a message"><br><br>
              <button class="btn btn-success" style="width:100%;">send message to <?php echo $userName; ?></button>
       </form><br>
        <!-- <div class="row ">

...
$adID = "";
$pageUsrID__=$_SESSION['gaijinmall_user_admin__'];
/*
...
if (isset($_GET['adID'])) {
  ...
  $allAdByID = $adManager_ob->getAllAdByID($adID);
...
<head>
  ...
  <link rel="stylesheet" href="../../views/assets/css/vertical-menu.css">
...
<body class="bg-light-blue">
  ...
  <a href="ads.php" class="btn btn-primary">Back to Admin</a>
          ...
          <div class="card-body py-2 m-0">
            <a href="#">
              <div class="ha-seller__avatar__wrapper">
                <a href="<?php echo ($getUsrBizInfo['mallBizSlug']=="" || $getUsrBizInfo['mallBizSlug']=="NULL")?"#" : "shop/".$getUsrBizInfo['mallBizSlug']; ?>" class="ha-seller__icon profile-image-init__avatar bg-purple" style="background-image: url('');">
  ...
  <script src="../../views/assets/js/jquery.inputmask.min.js"></script>

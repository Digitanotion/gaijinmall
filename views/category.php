...
<head>
    ...
    <title><?php echo $categName;?> | Gaijinmall</title>
    ...
    <div class="container p-0 p-md-0 mx-auto">
       <!--  <div class="row m-0 justify-content-center">
        ...
        <div class="row mx-2 mx-md-0 mx-lg-0 p-0">
                <div class="col-md-3 col-lg-3 col-12 ms-lg-0 ms-md-0 my-md-0 my-lg-0 me-md-3 me-lg-3  " >
                    <div class="p-0 m-0 bg-white pb-3 rounded">
                      <div class="bg-primary p-2 text-white fs-md fw-bold rounded-top">
                        <?php echo $categName;?>
                      </div>  
                    ...
                    <div class="my-3 px-2 bg-white ha-category-locate rounded" data-bs-toggle="modal" data-bs-target="#statesJapan">
                            ...
                            <div class="ha-category-filter__body">
                              <form class="my-3 ">
                                ...
                                <div class="form-check ">
                                  <input type="checkbox" name="<?php $cateOptionAll=explode(" ",$categOptionValues[$i]); echo trim($categOptionName[0])."_".trim($categOptionValues[$i]);?>" id="<?php echo trim($categOptionName[0])."_".trim($categOptionValues[$i]);?>" class="form-check-input p-2 ha-filter__attribs">
                                  <label class="form-check-label fs-md ms-2 py-1 font-inter" for="<?php echo trim($categOptionName[0])."_".trim($categOptionValues[$i]);?>"><?php echo trim(ucwords($categOptionValues[$i])) ?> <!-- <span class="badge bg-purple">6,000 Ads</span> --></label>
                                </div>
                                <?php } ?>
                              </form>
                            </div>
                ...
                <div class="col-12 col-md-8 col-lg-8 me-md-2 me-lg-2">
                      <div class="ha-category-sort__wrapper d-flex justify-content-end my-3">
                          <span class="fs-title-1 fw-bolder">Sort By:</span> 
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-header">
               <h5 class="modal-title" id="exampleModalLabel">Locations in Japan <!--<span class="badge bg-purple fs-md">92428 Ad</span>--></h5>  

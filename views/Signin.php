...
if (isset($_POST['btn_Auth_User'])) {
    if ($securityManager_ob->validateCSRF($_POST['form_token__input'])) {
        if ($auth_user_response = $securityManager_ob->is_user_auth__($_POST['txt_Auth_emailPhone'])) {

            //echo $_SESSION['gaijinmall_user_'];
        } else {
            //echo "No Session";
        }
        $auth_user_response = $securityManager_ob->auth__user($_POST['txt_Auth_emailPhone'], $_POST['txt_Auth_pwd']);
                    ...
                    <form id="formSign" action="" method="POST" class="top--space mb-3">
                        <div class="row">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="txt_Auth_emailPhone" id="txt_Auth_emailPhone" class="form-control p-3 fs-md-1" placeholder="Enter your email address">
                            </div>
                            ...
                            <div class="form-group ">
                                ...
                                <div class="input-group">
                                    <input type="password" data-toggle="password" name="txt_Auth_pwd" id="txt_Auth_pwd" class="form-control p-3 fs-md-1" placeholder="************">

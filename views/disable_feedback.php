        ...
        <section class="container-fluid m-0 p-0">
            ...
            <?php include "settings_side__bar.php";?>
                ...
                <div class="px-4 py-4 d-flex justify-content-between">
                    <div class="">
                        <span class="fs-title-3 fw-bolder" id="header01"><?php echo ($getUsrFeedStatus['status']==1)? (($getUsrFeedStatus['message']['mallUsrFeedbacks']==1)? "Disable":"Enable") : "Disable"; ?>  feedbacks</span>

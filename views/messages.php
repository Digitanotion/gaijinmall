...
<html lang="en">
  <head>
    ...
    <title>My Messages | Gaijinmall</title>
    <meta name="theme-color" content="#c3e6ff">
    <link rel="shortcut icon" href="./assets/images/favicon.png">
    <link rel="stylesheet" href="views/assets/css/personal-buiness.css" />
    <link
      rel="stylesheet"
      href="../dependencies/node_modules/bootstrap/dist/css/bootstrap.min.css"
    />
    <link
      rel="stylesheet"
      href="../dependencies/node_modules/toastr/build/toastr.min.css"
    />
    <link
    ...
    <link
      rel="stylesheet"
      href="./assets/fonts/fontawesome-free-6.0.0-web/css/all.css"
    />
  ...
  <?php include "header-top.php"; ?>
    <section class="container-fluid m-0 p-0">
      <div
        class="row m-0 mx-sm-5 mx-md-5 mx-lg-5 mt-2 gx-0 gx-md-5 gx-lg-5 justify-content-between " >
        ...
        <div class="col-md-8 col-lg-8 col-sm-12 p-0 shadow-sm bg-white rounded-3 p-0 ha-message__contents">
          ...
          <div class="ha-profile-url-data__body">
            <div class="ha-none__display w-50 text-center mx-auto mt-0">
              <div class="">
                <img
                  src="assets/images/messaging.svg"
                  class="messageim w-75"
                  alt=""
                />
              </div>
            </div>

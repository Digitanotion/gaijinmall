        ...
        <?php include "sidebar.php";?>
            <div class="col-md-8 col-lg-8 col-sm-12 p-0 shadow-sm bg-white rounded-3 p-0">
                <div class="px-4 py-4 d-flex justify-content-between">
                    <div class="">
                        <span class="fs-title-3 fw-bolder" id="prof1">Notifications</span>
                    </div>
                    <div class="text-center">
                        <!-- <span class="btn text-primary opacity-75 fs-md p-2" onclick="myNotify()"> Mark all as read </span> -->
                    </div>
                </div>

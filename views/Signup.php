                    ...
                    <form id="formSignup" action="" method="POST" class="top--space mb-3">
                        <div class="row">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" required name="txt_New_phone" id="txt_New_phone" class="form-control p-3 fs-md-1" placeholder="Enter your phone">
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group">
                                    <input type="password" data-toggle="password" required name="txt_New_pwd" id="txt_New_pwd" class="form-control p-3 fs-md-1" placeholder="************">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="password" data-toggle="password" required name="txt_New_verifypwd" id="txt_New_verifypwd" class="form-control p-3 fs-md-1" placeholder="************">
                                    <div class="input-group-append">
                                        <span class="input-group-text p-3">
                                            <i class="fa fa-eye"></i>
                                        </span>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <button type="submit" onclick="saveFormValue()" name="btn_New_user" id="btn_New_user" class="btn btn-primary btn-signindetails">Sign up</button>
                            </div>
                        </div>
            ...
            if (isset($sys_msg) && !empty($sys_msg)) {
                switch ($sys_msg['msg_type']) {
                    ...
                    case '1':
                        ...
                        cuteAlert({
                            type: "success",
                            message: "We sent a mail to you now to verify your account, kindly check spam box and mark gaijinMall as not spam for better experience",

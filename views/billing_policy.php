...
<body class="bg-light-blue">
    ...
    <section class="container-fluid m-0 p-0">
        <div class="row m-0 px-4 mx-sm-5 mx-md-5 mx-lg-5 mt-2 gx-0 gx-md-5 gx-lg-5 justify-content-between">
            ...
            <ul class="fs-md-2 fw-bold" style="list-style-type:disc; line-height:180%" start="1">
                <li>Promoting your advertisement to attract more users, You can use premium services provided by GaijinMall Administrator.</li>
                <li>Please visit https://gaijinmall.com/premium-service to order premium services, or choose a preferred premium service while creating an advertisement. You can also visit &ldquo;Premium Services&rdquo; section in your Profile or choose a preferred premium service while creating an advertisement .</li>
                <li>GaijinMall offers premium services Boost Pans such as Business Plan, Bronze Plan, Silver Plan, Gold Plan and Diamond Plan Promo. If you order a Boost Plan, your advertisement will be raised overall . They will be displayed on all pages of a column, a section, or a region. Top advertisement are placed in a separate block over the ordinary advertisement. Detailed information on the duration, price, payment methods and other conditions of premium services are available at: https://gaijinmall.com/premium-service</li>
                ...
                <li>GaijinMall reserves the right, in its sole discretion, to change the features and types of premium services, fees, and acceptable payment methods from time to time and for any reason.</li>
                <li>Unless otherwise provided by mandatory rules of the applicable law, any fees paid for premium services are non-refundable due to the online nature of the services. You acknowledge and agree that we will not make any prorated refunds in the event your advertisement violates Terms of Use and is removed from the Platform, or when you deactivate an advertisement by yourself.</li>
                <li>Premium Silver, Gold and Diamond Promo Plans is subject to a 12 months validity period max from the date of purchase (the &ldquo;Service Validity Period&rdquo;). You acknowledge and agree that if you fail to use the Promo package during the Service Validity Period, you will have neither the right to initiate or use such Promo package nor any right to refund, compensation or replacement. Premium ad are NOT refundable.</li>
                ...
                <li>GaijinMall does not guarantee any results of premium services and will not be held liable if they do not meet your expectations.</li>
            </ul>
            
            
            
            <p><strong>.Referral Program</strong></p>
            <ol class="fs-md-2 fw-bold" start="10">
                <li>Our referral program allows you to earn bonuses (the &ldquo;Referral Bonuses&rdquo;) for each Valid Referral. The referral is valid if: (i) the referred friend creates an account on the Platform, and (ii) the referred friend confirms his/her phone number on the Platform.</li>
                ...
                <li>Referral Bonuses may be (i) used to pay for premium services on the Platform; 1 Referral Bonus will be equal to 100 Yen.</li>
                <li>Referral Bonuses must be used within 12 months from the date they are credited on your account (the &ldquo;Referral Bonuses Validity Period&rdquo;), after which they will expire. You acknowledge and agree that if you fail to use the Referral Bonuses during the Referral Bonuses Validity Period, you will lose your right to use them and you will not be entitled for any refund, compensation or replacement.</li>
            ...
            <p>your account on the Platform is inactive (i.e., not used or logged into) for one year;</p>
            <p>you fail to comply with the Terms (Terms of Use, Privacy Policy);</p>
            <p>we suspect fraud or misuse by you of the Referral Bonuses and the service;</p>
            <p>we suspect any other unlawful activity associated with your account;</p>
            <p>we are acting to protect the service, any of our users, or our reputation.</p>
            <ol class="fs-md-2 fw-bold" start="16">
            ...
            <ol class="fs-md-2 fw-bold" start="17">
                <li>You can purchase credits on the Platform (the &ldquo;Credits&rdquo;) that may only be used to pay for the premium services. When you pay for the premium services, 1 Credit will be equal to 100 Yen.</li>
                <li>Credits must be used within 12 months from the date of purchase (the &ldquo;Credits Validity Period&rdquo;), after which they will expire. You acknowledge and agree that if you fail to use the Credits during the Credits Validity Period, you will lose your right to use them and you will not be entitled for any refund, compensation or replacement.</li>
            ...
            <p>your account on the Platform is inactive (i.e., not used or logged into) for one year;</p>
            <p>you fail to comply with the Terms (Terms of Use, Privacy Policy);</p>
            <p>we suspect fraud or misuse by you of the Credits and the service;</p>
            <p>we suspect any other unlawful activity associated with your account;</p>
            <p>we are acting to protect the service, any of our users, or our reputation.</p>
            <ol start="22">

...
$adID = "";
$pageUsrID__ = $_GET['user_mob_id__']; //$_SESSION['gaijinmall_user_'];
/*
      ...
      <div class="col-md-8 me-md-2 me-md-2 ">
        <div class="container p-0 m-0 g-0">
          ...
          <div class="row my-4 my-md-4 my-lg-4">
            <div class="card">
              <div class="card-body">
                <h6 class="fw-bolder"><?php echo $allAdByID['mallAdTitle']; ?></h6>
                <div class="">
                  ...
                  if (count($getActiveAdOptions['message']) > 0) { ?>
                    <button class="btn-mobile btn-outline-primary-mobile m-0 w-100" type="button" data-bs-toggle="collapse" data-bs-target="#ha-product__attributes" aria-expanded="false" aria-controls="ha-product__attributes">
                      Show Ad Detail...
                    </button>
                  <?php } ?>
                </div>
      ...
      <div class="col-md-3 p-0 my-md-0 my-lg-0">
        ...
        <div class="card py-3 px-3 shadow-sm border-0">
          <div class="card-body py-2 m-0">
            ...
            <div class="form-group ">
              <div class="ha-price_button_offer my-2">
                <button class="ob-make-offer__btn btn-mobile btn-outline-danger-mobile w-100 reportAd__btn" <?php echo ($pageUsrID__ == "null") ? "" : 'data-bs-toggle="modal" data-bs-target="#reportAd"'; ?>><i class="fa fa-flag"></i>Report Ad</button>
              </div>
            </div>
          </div>
        </div>

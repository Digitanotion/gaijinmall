...
<head>
    ...
    <script type="text/javascript">
        //This function will send page title to APP

        function sendPageTitle() {
            //header.innerText = 'Hello';
            var getDomTitle = document.title;
            //alert (_(getDomTitle).truncate(5));
            sendToApp.postMessage("title:" + getDomTitle + ", icon:icon1232");
        }
        //This function will be triggered by the APP
        function callFromApp(datIt) {
            document.getElementById("container").value = datIt;
        }
        sendPageTitle();
    </script>
...
<body>
    ...
    <section class="container-fluid m-0  mx-auto">
    <div class="row m-0 mx-sm-5 mx-md-5 mx-lg-5 gx-0 gx-md-5 gx-lg-5">
            <div class="col-md-12 col-lg-12 col-sm-12 px-2 " id="demo000">
              
                <div class="ha-none__display w-100 text-center under_fixed-elemen">
                    <form action="" method="post">
                        <?php   
                            if ($getUsrBizInfo['mallBizStatus'] == 0) { ?>
                                <div class="alert bg-danger fs-6 text-light">
                                    <span class=""><i class="fa fa-exclamation-circle "></i>Business not verified, </span> <a href="verify_business.php" class="text-primary text-bold text-underline"> <b>Verify Now</b></a>
                                </div>
                            <?php  } else { ?>
                        ...
                        <div class="btn-group mt-3  buttoninpt" role="group" aria-label="Basic checkbox toggle button group">
                        ...
                        <div><button class="mt-3 mb-4 btn w-100" style="color: white; background-color: rgb(72, 72, 250);" id="demo1001" type="submit" name="editBizUpdate_settings">Save</button></div>

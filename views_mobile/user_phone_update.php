                        ...
                        <div class="number_0" id="number0">
                            ...
                            <form action="" method="POST">
                                <span class="d-flex justify-content-around">
                                    ...
                                    <button class="p-2 bg-light ms-1 rounded" name="edit_phone__btn" type="button" onclick="myPhone()" <?php //echo ($isUsrIDUploaded['status'] == 1) ? 'type="submit"' : 'type="button" onclick="myPhone()"'; 
                                                                                                                                                    ?>><i class="fa fa-pencil m-0 mx-1 fs-title-4"></i></button>
                                </span>
                            ...
                            <a href="javascript:void">
                                <div class="text-dark ">
                                    <form class="row" action="" method="POST">
                                        <span>
                                            <input type="tel" name="usrIDPhone__txt" id="usrIDPhone__txt" placeholder="New phone number*" class="form-control p-2" onchange="myEnable()">
                                        </span>
                                        <span>
                                            <button class="btn-mobile btn-primary-mobile mt-2 w-100 text-white fw-bolder" disabled id="enable0" type="submit" name="usrIDSubmit__btn">Apply Changes</button>
                                        </span>

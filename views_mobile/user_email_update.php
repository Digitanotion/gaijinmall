        ...
        <div class="row m-0 mx-sm-5 mx-md-5 mx-lg-5 gx-0 gx-md-5 gx-lg-5 justify-content-between">
            <div class="col-12 ">
                ...
                <!-- <div class="py-4 text-center fixed-top bg-white">
                    <div class="">
                        <h6 class="fs-title-5 fw-bolder p-0" id="prof1">CHANGE EMAIL NUMBER</h6>
                    </div>
                </div> -->
                    <!-- Horizontal line -->
                        ...
                        <span class="d-flex  justify-content-center">
                            ...
                            <form action="" method="POST">
                                <span class="d-flex justify-content-around ">
                                    <input type="email" id="disabledTextInput" value="<?php echo $getUsrInfo['mallUsrEmail'];?>" name="edit_email__txt" <?php echo ($isUsrIDUploaded['status'] == 1) ? "" : "disabled"; ?> class="form-control p-2">
                                    
                                </span>
                                <button class="mt-2 w-100 btn-mobile btn-primary-mobile text-primary fw-bold text-primary" name="edit_email__btn" <?php echo ($isUsrIDUploaded['status'] == 1) ? 'type="submit"' : 'type="button" onclick="myPhone()"'; ?>>Verify</button>
                            </form>
                ...
                <form class="row m-2 pt-4" action="" method="POST" enctype="multipart/form-data">
